            ...
            <table class="w-full text-left border-collapse" aria-label="Inbox messages list">
                ...
                <tbody class="divide-y divide-slate-100 text-body text-brand-ink/80">
                    @forelse($messages as $msg)
                        <tr class="hover:bg-slate-50/50 transition-colors {{ $msg->status->value === 'unread' ? 'bg-brand-blush-lt/5 font-semibold text-brand-primary' : '' }}">
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-3">
                                    <button 
                                        ...
                                        type="button" 
                                        class="p-1.5 text-brand-primary hover:bg-brand-primary/5 rounded-lg font-semibold text-caption"
                                    >
                                        Buka
                                    </button>
                                    <button 
                                        wire:click="toggleStatus({{ $msg->id }})" 
                                        type="button" 
                                        class="p-1.5 text-slate-500 hover:bg-slate-100 rounded-lg font-semibold text-caption"
                                        title="{{ $msg->status->value === 'unread' ? 'Tandai Dibaca' : 'Tandai Belum Dibaca' }}"
                                    >
                                    ...
                                    <button 
                                        ...
                                        type="button" 
                                        class="p-1.5 text-red-600 hover:bg-red-50 rounded-lg font-semibold text-caption"
                                    >
                                        Hapus
                                    </button>
                                </div>
