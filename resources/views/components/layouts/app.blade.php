                ...
                <div class="flex gap-4">
                    @php
                        $socials = [
                            ...
                            'threads' => ['url' => \App\Models\Setting::get('social.threads'), 'icon' => '<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12.22 2c-5.51 0-9.98 4.47-9.98 9.98S6.71 21.96 12.22 21.96c2.48 0 4.74-.91 6.51-2.43l-1.39-1.39c-1.39 1.15-3.17 1.84-5.12 1.84-4.4 0-7.98-3.58-7.98-7.98s3.58-7.98 7.98-7.98c4.01 0 7.34 2.98 7.89 6.89h-3.41c-.44-1.18-1.57-2.02-2.91-2.02-1.76 0-3.19 1.43-3.19 3.19s1.43 3.19 3.19 3.19c1.34 0 2.47-.84 2.91-2.02h3.41c-.53 3.86-3.83 6.81-7.81 6.81-4.4 0-7.98-3.58-7.98-7.98s3.58-7.98 7.98-7.98c2.48 0 4.74.91 6.51 2.43l-1.39 1.39c-1.39-1.15-3.17-1.84-5.12-1.84z"/></svg>'],
