...
<head>
    ...
    <!-- Fonts (DM Serif Display, Poppins, Alex Brush) -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Poppins:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&family=Alex+Brush&display=swap" rel="stylesheet">
...
<body class="font-sans text-brand-ink bg-brand-cream antialiased min-h-screen flex flex-col selection:bg-brand-accent/30 selection:text-brand-primary overflow-x-hidden">
    ...
    >
        ...
        <div class="absolute top-[-10%] left-[-20%] w-[500px] h-[500px] rounded-full bg-brand-primary/12 filter blur-[120px] pointer-events-none z-0"></div>
        <div class="absolute top-[30%] right-[-10%] w-[600px] h-[600px] rounded-full bg-brand-accent/12 filter blur-[150px] pointer-events-none z-0"></div>
        <div class="absolute bottom-[10%] left-[10%] w-[500px] h-[500px] rounded-full bg-brand-blush/12 filter blur-[120px] pointer-events-none z-0"></div>
                ...
                <div class="flex gap-4">
                    @php
                        $socials = [
                            ...
                            'threads' => ['url' => \App\Models\Setting::get('social.threads', 'https://www.threads.com/@taqwamovement?igshid=NTc4MTIwNjQ2YQ=='), 'icon' => '<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 16 16"><path d="M6.321 6.016c-.27-.18-1.166-.802-1.166-.802.756-1.081 1.753-1.502 3.132-1.502.975 0 1.803.327 2.394.948s.928 1.509 1.005 2.644q.492.207.905.484c1.109.745 1.719 1.86 1.719 3.137 0 2.716-2.226 5.075-6.256 5.075C4.594 16 1 13.987 1 7.994 1 2.034 4.482 0 8.044 0 9.69 0 13.55.243 15 5.036l-1.36.353C12.516 1.974 10.163 1.43 8.006 1.43c-3.565 0-5.582 2.171-5.582 6.79 0 4.143 2.254 6.343 5.63 6.343 2.777 0 4.847-1.443 4.847-3.556 0-1.438-1.208-2.127-1.27-2.127-.236 1.234-.868 3.31-3.644 3.31-1.618 0-3.013-1.118-3.013-2.582 0-2.09 1.984-2.847 3.55-2.847.586 0 1.294.04 1.663.114 0-.637-.54-1.728-1.9-1.728-1.25 0-1.566.405-1.967.868ZM8.716 8.19c-2.04 0-2.304.87-2.304 1.416 0 .878 1.043 1.168 1.6 1.168 1.02 0 2.067-.282 2.232-2.423a6.2 6.2 0 0 0-1.528-.161"/></svg>'],
                            'tiktok' => ['url' => \App\Models\Setting::get('social.tiktok'), 'icon' => '<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12.53.02C13.84 0 15.14-.01 16.44 0c.08 1.53.63 3.02 1.59 4.18.96 1.13 2.31 1.89 3.79 2.11v3.98c-1.68-.04-3.32-.58-4.73-1.53V15.5c-.01 1.63-.52 3.22-1.46 4.54-1.28 1.76-3.31 2.87-5.52 3-2.26.11-4.52-.69-6.14-2.26C2.26 19.14 1.34 16.82 1.51 14.5c.14-2.27 1.25-4.36 3.03-5.69 1.65-1.22 3.73-1.78 5.78-1.54V11.3c-1.12-.29-2.34-.1-3.3.52-.96.64-1.55 1.72-1.59 2.88-.06 1.52.82 2.97 2.21 3.58 1.45.62 3.19.23 4.23-.92.8-.9 1.19-2.12 1.18-3.32-.01-4.66.01-9.33-.02-13.98z"/></svg>'],
                        ];
                    @endphp
