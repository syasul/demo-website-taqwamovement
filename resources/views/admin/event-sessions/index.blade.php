<x-layouts.admin>
    ...
    <div x-data="{ selected: [], singleDeleteUrl: '' }">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div x-data="{ open: false }" class="relative inline-block text-left">
                                        ...
                                        >
                                            ...
                                            <button 
                                                @click="singleDeleteUrl = '{{ route('admin.event-sessions.destroy', $session->id) }}'; $dispatch('open-modal', 'single-delete-confirm-modal')"
                                                type="button" 
        ...
        <x-ui.modal id="bulk-delete-confirm-modal" title="Konfirmasi Hapus Terpilih">
            <form method="POST" action="{{ route('admin.event-sessions.bulk-destroy') }}">
                @csrf
                @method('DELETE')
        ...
        <x-ui.modal id="single-delete-confirm-modal" title="Konfirmasi Hapus Sesi">
