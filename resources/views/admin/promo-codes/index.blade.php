<x-layouts.admin>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div x-data="{ open: false }" class="relative inline-block text-left">
                                        ...
                                        >
                                            ...
                                            <form method="POST" action="{{ route('admin.promo-codes.destroy', $code->id) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kode promo ini?');" class="block w-full">
                                                @csrf
                                                @method('DELETE')
    ...
    <x-ui.modal id="bulk-delete-confirm-modal" title="Konfirmasi Hapus Terpilih">
        <form 
            method="POST" 
            action="{{ route('admin.promo-codes.bulk-destroy') }}" 
            class="space-y-6"
        >
            @csrf
            @method('DELETE')
