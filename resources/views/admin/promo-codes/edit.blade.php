<x-layouts.admin>
    @section('page_title', 'Ubah Kode Promo')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1">
                    ...
                    >
                        ...
                        @foreach($ticketTypes as $type)
                            <option value="{{ $type->id }}" {{ old('ticket_type_id', $promoCode->ticket_type_id) == $type->id ? 'selected' : '' }}>
                ...
                <div class="space-y-1">
                    ...
                    <input 
                        ...
                        name="valid_until" 
                        required
                        value="{{ old('valid_until', $promoCode->valid_until ? \Carbon\Carbon::parse($promoCode->valid_until)->format('Y-m-d\TH:i') : '') }}"
                        class="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-brand-primary focus:ring-2 focus:ring-brand-accent/30 text-body"
                    />
